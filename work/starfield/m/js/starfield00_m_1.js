...
//$(function(){
//    $('.fooer_icon_p > a em').eq(0).on('mouseover',function() {
//        $('.footer_on').css({
//            'background-image':'url(img/footer_icon03_none.png)'
//        });
//        $('.fo_ic_p:nth-child(3) > a').css({
//           'color':'#b1a9a3'
//        });
//    });
//    
//    $('.fooer_icon_p > a em').eq(1).on('mouseover',function() {
//        $('.footer_on').css({
//            'background-image':'url(img/footer_icon03_none.png)'
//        });
//        $('.fo_ic_p:nth-child(3) > a').css({
...
//    });
//    
//    $('.fooer_icon_p > a em').eq(2).on('mouseover',function() {
//        $('.footer_on').css({
...
//    });
//    
//    $('.fooer_icon_p > a em').eq(3).on('mouseover',function() {
//        $('.footer_on').css({
//            'background-image':'url(img/footer_icon03_none.png)'
//        });
//        $('.fo_ic_p:nth-child(3) > a').css({
...
//    });
//    
//    $('.fooer_icon_p > a em').eq(4).on('mouseover',function() {
//        $('.footer_on').css({
//            'background-image':'url(img/footer_icon03_none.png)'
//        });
//        $('.fo_ic_p:nth-child(3) > a').css({
